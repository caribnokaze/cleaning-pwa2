    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        {screen === "review" && <>
          ...
          <View style={styles.notice}><Text style={styles.noticeTitle}>現在は正式UIの検証段階です</Text><Text style={styles.noticeText}>この画面から本番への送信は行いません。次工程で検証専用APIへ接続します。</Text></View>
          <View style={styles.navigationRow}><SecondaryButton label="写真を修正" onPress={() => setScreen("photos")} /><View style={styles.disabledSubmit}><Text style={styles.disabledSubmitText}>送信（未接続）</Text></View></View>
        </>}
...
const styles = StyleSheet.create({
  ...
  notice: { marginTop: 16, padding: 14, borderRadius: 10, backgroundColor: "#fff6df", borderWidth: 1, borderColor: "#ecd49a" }, noticeTitle: { color: "#765200", fontWeight: "900", marginBottom: 5 }, noticeText: { color: "#765f25", fontSize: 13, lineHeight: 19 }, disabledSubmit: { flex: 1, minHeight: 52, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: "#b8c2bf" }, disabledSubmitText: { color: "#fff", fontSize: 16, fontWeight: "800" }, error: { marginTop: 18, color: "#b42318", fontSize: 14, lineHeight: 20 },
});
